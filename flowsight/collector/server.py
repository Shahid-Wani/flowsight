...
from flowsight.parser import parse_flow_packet
...
class NetFlowV5Handler(FlowProtocolHandler):
    ...
    def parse(self, data: bytes, source_ip: str, source_port: int) -> list[dict[str, Any]]:
        ...
        for i in range(count):
            ...
            (
                src_addr, dst_addr, next_hop, input_iface, output_iface,
...
class FlowCollector:
    ...
    def _init_handlers(self):
        ...
        # NetFlow v9, IPFIX, sFlow handlers will be added in Day 2-3
